...
import { Send, User, Bot, ArrowRight, X, Cpu, Server, Zap, Sparkles, Moon, Sun, Copy, Check, Trash2, Mail } from 'lucide-react';
import './App.css';
    ...
    <div className="app-container">
      ...
      <nav className="top-nav">
        ...
        <div className="nav-actions">
          <a href="https://www.linkedin.com/in/avinashrofficial/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
            <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
          </a>
          <a href="https://github.com/avinashroffl" target="_blank" rel="noopener noreferrer" title="GitHub">
